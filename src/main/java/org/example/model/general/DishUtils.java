...
public class DishUtils {
    ...
    public static List<Dish> menu = Arrays.asList(
            new Dish("Pasta", 10, "Veg"),
            new Dish("Salad", 20, "Veg"),
            new Dish("Burger", 80, "Veg"),
            new Dish("Paplet", 100, "SeaFood"),
            new Dish("Chicken", 120, "NonVeg")
    );
                        ...
                        Collectors.groupingBy(
                                ...
                                Collectors.mapping(
                                        dish -> {
                                            ...
                                            if(dish.getCalories() <= 20) return CaloricLevel.DIET;
                                            else if(dish.getCalories() <= 50) return CaloricLevel.NORMAL;
    ...
    public static Map<String, Set<CaloricLevel>> caloricLevelsByType(List<Dish> list) {
         ...
         return list.stream().collect(
                Collectors.groupingBy(
                        ...
                        Collectors.mapping(
                                d -> {
                                    if(d.getCalories() <= 20) return CaloricLevel.DIET;
                                    else if(d.getCalories() <= 50) return CaloricLevel.NORMAL;
                                    else return CaloricLevel.FAT;
                                }, Collectors.toSet()
...
//                ));
    ...
    static public  Map<String, Map<CaloricLevel, List<Dish>>> multiLevelGrouping(List<Dish> list) {
        ...
        Map<String, Map<CaloricLevel, List<Dish>>> dishesByTypeCaloricLevel = list
                .stream()
                .collect(
                        Collectors.groupingBy(
                                Dish::getType,
